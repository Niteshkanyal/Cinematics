          ...
          renderItem={({ item }) =>
            <View style={{ flex: 1, flexDirection: 'column', marginTop: height * 0.02 }}>
              <View style={{ flex: 0.1, flexDirection: 'row' }}>
                ...
                <View style={{ flex: 0.3 }}>
                  <Text style={{ fontSize: 17, fontWeight: 'bold', color: 'black' }}>SEASON {item.season_number}</Text>
                </View>
                <View style={{ flex: 0.3 }}>
                  <Text style={{ fontSize: 14, fontWeight: 'bold', color: 'black' }}>{item.episode_count} episodes</Text>
                </View>
              ...
              <View>
                <Image indicator={ActivityIndicator}
                  ...
                  style={{ marginLeft: width * 0.05, height: height * 0.3, width: width * 0.9 }}
                />
              </View>
            </View>
          }
